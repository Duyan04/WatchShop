...
function IconBase(props) {
  var elem = function(conf) {
    var attr = props.attr, size4 = props.size, title = props.title, svgProps = __rest(props, ["attr", "size", "title"]);
...
var Trigger = ({ refs, children, inline: inline4, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline4 ? (0, import_jsx_runtime31.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime31.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react29.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size4 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime61.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size4], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size4 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime62.jsx)(RatingContext.Provider, { value: { size: size4 }, children: (0, import_jsx_runtime62.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Tooltip = ({ animation = "duration-300", arrow: arrow4 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime93.jsx)(Floating, { animation, arrow: arrow4, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
